    ...
    with U.single_threaded_session():
        ...
        while True:
            ...
            if done or terminal:
                ...
                #     dict_state.append({'UAV {}'.format(i): agent.state.p_pos})
                # dict_state.append({'bandwidth': env.world.bandwidth, 'SNR': env.world.SNR, 'Rate': env.world.Rate})
                #
                # with open('./state_results/results.txt','a') as f:
                #     f.write('******************************' + 'episode {}'.format(len(episode_rewards)) + '******************************' + '\n')
                #     f.write(str(dict_state) + '\n')

                # bnadwidth = env.world.bandwidth
                # Rate = env.world.Rate
                # SNR = env.world.SNR
                # print(final_pos)
                # print(bnadwidth)
